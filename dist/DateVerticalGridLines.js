...
function (_PureComponent) {
  ...
  function DateVerticalGridLines(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DateVerticalGridLines).call(this, props));
  ...
  _createClass(DateVerticalGridLines, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("canvas", _extends({
        ref: this.ref,
        width: width,
        height: height
      }, rest), " ");
